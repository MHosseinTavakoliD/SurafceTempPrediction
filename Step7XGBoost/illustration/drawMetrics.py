...
axes[0].plot(data['Estimator'], data['Val_MSE'], label='Validation MSE', color='green')  # Change line color here
...
axes[1].plot(data['Estimator'], data['Train_MAE'], label='Train MAE', color='red')  # Change line color here
axes[1].plot(data['Estimator'], data['Val_MAE'], label='Validation MAE', color='purple')  # Change line color here
